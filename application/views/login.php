...
function setLogin()
{
  ...
  if(txt_username.value === "")
  {
    ...
    //err.username.style.fontsize = '30px';
  ...
  if(status_username == 1 && status_password == 1)
  {
    ...
    if(txt_username.value === "KA" && txt_password.value === "FTIK")
    {
      ...
      let chk_ingat = document.
      getElementById("chk_ingat");
      ...
      //alert(chk);
      //alihkan ke halaman dashboard (controller) "Dashboard"
...
//buat fungsi untuk halaman Dashboard
